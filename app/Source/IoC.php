...
class IoCServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->bind('App\Source\DAL\Interfaces\Services\ICompanyService', 'App\Source\DAL\Services\CompanyService');
        $this->app->bind('App\Source\DAL\Interfaces\Services\IDemandService', 'App\Source\DAL\Services\DemandService');
